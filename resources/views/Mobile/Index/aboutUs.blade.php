...
<link rel="stylesheet" href="{{asset('Mobile/css/aboutUs.css')}}">
    <div data-role="page" id="pageone">
      ...
      <div class="centera">
        <ul id="oranger"> 
          <li><a class="hover" href="javascript:;">公司介绍</a> </li>
          <li><a href="javascript:;">创始人吴婷</a> </li>
        ...
        <div id="tablea" class="tablea">
          <div class="box">
              ...
              <div class="con con_com">
                深圳嘉宾传媒有限公司创立于2016年，是新时代下新商业与新商学的生态打造者，出品优质商业内容、提供商学教育服务，目前已创立《我有嘉宾》全媒体产品、嘉宾大学教育平台。每年公司陪跑与服务全球范围内500+商业领袖，优质内容触达与影响中高端人群达6亿人次；同时公司为诸多高速成长中的企业提供战略咨询、品牌服务、价值管理、投融资服务等，帮助企业打开见识、重构认知、链接价值，并将见识转化为生产力。嘉宾传媒创办以来获得深创投、同创伟业等顶尖投资机构， 以及阎焱、吴军、李斌、倪正东等商界知名人士投资，与美的、奥飞、58集团、科大讯飞、奇瑞、比亚迪、蔚来汽车、 BOSS直聘、一下科技、首汽移动出行、京东、百度、小米、VIPKID、华大基因、柔宇科技、优客工场、永安行、洛可可等数百家企业达成长期战略合作关系，共建新商业生态；并与芜湖市人民政府、中国人民大学商学院、中国人民大学创业学院、中国青年天使会、中国国际青年交流中心等政府机关、组织机构成为战略伙伴，共同在商业、传媒、教育、投资、 研究等多个领域探索与尝试。              
              </div>
              ...
              <p class="logo logolit">
                  <img src="{{asset('Mobile/images/wyjb_logo.png')}}" alt="">
              </p>
              ...
              「我有嘉宾」节目以纪实的手法走访和对话了国内外近百位顶级商界领袖与新兴产业造物者，如周鸿祎、刘庆峰、姚劲波、 冯仑、吴军、马东、吴声、王煜全、毛大庆、米雯娟、周剑、胡海泉、赵普、周航、贾伟等。节目在广东卫视、山东电视台等电视渠道，腾讯、爱奇艺、优酷、PPTV等网络视频平台，及北上深等一线城市各大机场同步播放，每年触达中高端用户超过3.5亿人次。                    
              </div>
              <div class="fouth_tit">
                  「我有嘉宾」品牌峰会&案例榜单发布
              </div>
              <div class="second_con">
              「我有嘉宾」品牌峰会旗下有商界领袖年度峰会、独角兽峰会、行业公开课、商界歌王争霸赛等，已在北京、上海、深圳、 广州、三亚、合肥、芜湖等地举办。来自国内外人工智能、大数据、移动出行、新零售新消费、智能制造、前沿科技、文创教育、金融投资等行业领袖到场授课、分享、思辨、交流，数万名创业者和投资人前来参会及高密度学习，峰会跨界、 开环，累计传播影响过亿人次，是商界一大主流盛会与独特风景。
              </div>
              <div class="second_con">
              2017年，嘉宾传媒联合FT中文网（Financial Times）共同推出“时代影响力·中国商业案例榜单TOP30”，旨在为新时代下的优秀商业案例作注。评委团由国际知名经济学家、院士、教授、产业与投资界专家共同组成，京东、小米生态链、微信、华为消费者BG、蚂蚁金服、华大基因、得到等企业案例都登上榜单。
              </div>
              <div class="fouth_tit">
                  「我有嘉宾」商业案例与人物特稿
              </div>
              <div class="second_con">
              「我有嘉宾」聚焦新商业，挖掘新案例，每天讲述一个零距离商业故事，为时代著书、为企业立传，传承企业家精神、传递正向的企业价值观。「我有嘉宾」在微信公众平台、小程序、微博、今日头条、搜狐、网易、界面、大鱼号、一点资讯、 百度百家、企鹅号、新浪财经、凤凰号、天天快报、WIFI万能钥匙、财经头条等全媒体矩阵精准覆盖用户超2亿，每月文章阅读数超6000万。
              </div>
              <div class="second_tit">
                  教育
              </div>
              <p class="logo logolit">
                  <img src="{{asset('Mobile/images/jbdx_logo.png')}}" alt="">
              </p>
              <div class="fouth_tit_cen">
                  新商学教育品牌—嘉宾大学
              </div>
              ...
              <div class="class">
                  ...
                  <div class="class_right">
                      <p class="s_class"><span></span>线下课程——</p>
                      <div class="class_top">
          ...
          <div class="box">
            <dl class="wt">
              ...
              <dd>
                <p class="wtname">吴婷</p>
                <p class="wtcon">嘉宾传媒创始人,「我有嘉宾」出品人 嘉宾大学创办人.</p>
              </dd>
            </dl>
            <div class="con">
              创始人吴婷具备12年以上传媒行业经验，毕业于长江商学院， 现为中国人民大学创业导师、芜湖城市发展顾问、ECI商业创 意人、南方周末新锐品牌缔造人、猎云最佳女性创业者、金熊 猫国际纪录片等奖项获得者。曾任职于安徽电视台，曾任2004、 2008年雅典、北京奥运会火炬手。吴婷在职业生涯的前期以调 查记者、主持人身份奔走在民生一线、为百姓发声，奠定了强 大的群众基础。在转型后以纪录时代商业为己任，通过睿智犀 利的风格对话阎焱、熊晓鸽、倪泽望、徐小平、冯仑、毛大庆、 郑伟鹤、刘庆峰、周鸿祎、姚劲波、马东、吴声、米雯娟、林 斌、樊纲等数百位商界领袖与行业先锋人物，做船头瞭望者与 价值风向标。目前每年仍以主持人身份活跃在各大商界峰会， 曾受邀主持全球移动互联网大会GMIC鸟巢盛典、58集团年会、 深创投国际化战略发布会、新京报寻找中国创客峰会、ECI国 际数字商业创新节、经纬十周年、中国青年天使会慈善晚宴等 大型活动，并长期受邀担任投资界、投资中国、新浪、网易、 凤凰、36氪、虎嗅等平台的重量级主持，是业界公认的“创投 界最牛女主持”。
            </div>
            <div class="csr_list">
              <p class="time"><span></span>2016年至今</p>
              <p class="time_con">创办嘉宾传媒，出品制作《我有嘉宾》系列节目与案例，创办嘉 宾大学与见识研究院，每年纪录和陪跑500+领袖级企 业家成长。</p>
            </div>
            <ul class="csc_list">
              <li>获得猎云网最佳女性创业者；ECI中国商业创意人；</li>
              <li>带领嘉宾传媒获得南方周末2017年度新锐品牌；</li>
              <li>带领《我有嘉宾》获得PPTV 2017 PGC最受欢迎节目；</li>
              <li> 带领公司出品纪录片《一棵知道很多故事的树》，获人类 学大奖、入围广州纪录片“金红棉奖”。</li>
            </ul>
            <div class="csr_list">
          ...
          <div class="box">
            ...
            <div class="cooperation_bot">
                ...
                <p class="media_list_img">
                    <img src="{{asset('Mobile/images/wyjb.png')}}" alt="">
                </p>
                <p class="media_list">微信服务号：嘉宾大学</p>
                <p class="media_list_img">
                    <img src="{{asset('Mobile/images/jbdx_code.png')}}" alt="">
                </p>
            </div>
          </div>
        </div>
