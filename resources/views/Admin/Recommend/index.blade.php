...
@section('content')
            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <button class="btn btn-primary J_menuItem" data-toggle="modal" data-target="#myModalAdd">添加推荐位</button>
                        </div>
                                    ...
                                    <td class="center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="font-bold cgedit" data-toggle="modal" data-target="#myModalMod" url={{url('admin/recommend/'.$v->id)}} status={{$v->status}} >修改</a></li>
                                                <li class="divider"></li>
                                                <li><a href="javascript:;" id="{{$v->id}}" class="delete" url="{{url('admin/recommend/'.$v->id)}}">删除</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
    ...
    <div class="modal inmodal" id="myModalAdd" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form id="categoryAdd" method="post" action="{{url('admin/recommend')}}" class="form-horizontal m-t">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">推荐位权重：</label>
                        <div class="col-sm-8">
                            <input  name="rank" class="form-control" type="number" aria-required="true" aria-invalid="true" class="error">
                            <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 权重（0.1～1）值越大，排序越靠前，值相同按创建时间排序</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">推荐位状态：</label>
                        <div class="col-sm-4">
    ...
    <div class="modal inmodal" id="myModalMod" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form id="categoryMod" method="post" class="form-horizontal m-t" action="{{url('admin/recommend')}}">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">关闭</span>
                        </button>
                        <!-- <i class="fa fa-laptop modal-icon"></i> -->
                        <h5 class="modal-title">推荐位修改</h5>
                        <!-- <small class="font-bold">这里可以显示副标题。 -->
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">推荐位权重：</label>
                            <div class="col-sm-8">
                                <input  name="rank" class="form-control" type="number" aria-required="true" aria-invalid="true" class="error" id="mod_cgsort">
                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 权重（0.1～1）值越大，排序越靠前，值相同按创建时间排序</span>
                            </div>
                        </div>
                        <div class="form-group">
